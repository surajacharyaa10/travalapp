...
(function (Model) {
    ...
    Model[Model["ukmo_uk_ensemble_2km"] = 96] = "ukmo_uk_ensemble_2km";
    Model[Model["meteofrance_arome_france_hd_15min"] = 97] = "meteofrance_arome_france_hd_15min";
    Model[Model["meteofrance_arome_france_15min"] = 98] = "meteofrance_arome_france_15min";
    Model[Model["meteoswiss_icon_ch1"] = 99] = "meteoswiss_icon_ch1";
    Model[Model["meteoswiss_icon_ch2"] = 100] = "meteoswiss_icon_ch2";
    Model[Model["meteoswiss_icon_ch1_ensemble"] = 101] = "meteoswiss_icon_ch1_ensemble";
    Model[Model["meteoswiss_icon_ch2_ensemble"] = 102] = "meteoswiss_icon_ch2_ensemble";
    Model[Model["meteoswiss_icon_seamless"] = 103] = "meteoswiss_icon_seamless";
    Model[Model["ncep_nam_conus"] = 104] = "ncep_nam_conus";
    Model[Model["icon_d2_ruc"] = 105] = "icon_d2_ruc";
    Model[Model["ecmwf_seas5"] = 106] = "ecmwf_seas5";
    Model[Model["ecmwf_ec46"] = 107] = "ecmwf_ec46";
    Model[Model["ecmwf_seasonal_seamless"] = 108] = "ecmwf_seasonal_seamless";
    Model[Model["ecmwf_ifs_seamless"] = 109] = "ecmwf_ifs_seamless";
    Model[Model["jma_jaxa_mtg_fci"] = 110] = "jma_jaxa_mtg_fci";
    Model[Model["gem_hrdps_west"] = 111] = "gem_hrdps_west";
    Model[Model["ecmwf_wam"] = 112] = "ecmwf_wam";
    Model[Model["ncep_aigfs025"] = 113] = "ncep_aigfs025";
    Model[Model["ncep_aigefs025"] = 114] = "ncep_aigefs025";
    Model[Model["ncep_hgefs025_ensemble_mean"] = 115] = "ncep_hgefs025_ensemble_mean";
    Model[Model["ecmwf_seasonal_ensemble_mean_seamless"] = 116] = "ecmwf_seasonal_ensemble_mean_seamless";
    Model[Model["ecmwf_seas5_ensemble_mean"] = 117] = "ecmwf_seas5_ensemble_mean";
    Model[Model["ecmwf_ec46_ensemble_mean"] = 118] = "ecmwf_ec46_ensemble_mean";
    Model[Model["ncep_aigefs025_ensemble_mean"] = 119] = "ncep_aigefs025_ensemble_mean";
    Model[Model["dwd_icon_eps_ensemble_mean_seamless"] = 120] = "dwd_icon_eps_ensemble_mean_seamless";
    Model[Model["dwd_icon_eps_ensemble_mean"] = 121] = "dwd_icon_eps_ensemble_mean";
    Model[Model["dwd_icon_eu_eps_ensemble_mean"] = 122] = "dwd_icon_eu_eps_ensemble_mean";
    Model[Model["dwd_icon_d2_eps_ensemble_mean"] = 123] = "dwd_icon_d2_eps_ensemble_mean";
    Model[Model["ncep_gefs_ensemble_mean_seamless"] = 124] = "ncep_gefs_ensemble_mean_seamless";
    Model[Model["ncep_gefs025_ensemble_mean"] = 125] = "ncep_gefs025_ensemble_mean";
    Model[Model["ncep_gefs05_ensemble_mean"] = 126] = "ncep_gefs05_ensemble_mean";
    Model[Model["ecmwf_ifs025_ensemble_mean"] = 127] = "ecmwf_ifs025_ensemble_mean";
    Model[Model["ecmwf_aifs025_ensemble_mean"] = 128] = "ecmwf_aifs025_ensemble_mean";
    Model[Model["meteoswiss_icon_ch1_ensemble_mean"] = 129] = "meteoswiss_icon_ch1_ensemble_mean";
    Model[Model["meteoswiss_icon_ch2_ensemble_mean"] = 130] = "meteoswiss_icon_ch2_ensemble_mean";
    Model[Model["cmc_gem_geps_ensemble_mean"] = 131] = "cmc_gem_geps_ensemble_mean";
    Model[Model["ukmo_global_ensemble_mean_20km"] = 132] = "ukmo_global_ensemble_mean_20km";
    Model[Model["ukmo_uk_ensemble_mean_2km"] = 133] = "ukmo_uk_ensemble_mean_2km";
    Model[Model["dwd_sis_europe_africa_v4"] = 134] = "dwd_sis_europe_africa_v4";
    Model[Model["bom_access_global_ensemble_mean"] = 135] = "bom_access_global_ensemble_mean";
    Model[Model["ecmwf_wam025_ensemble_mean"] = 136] = "ecmwf_wam025_ensemble_mean";
    Model[Model["ncep_gefswave025_ensemble_mean"] = 137] = "ncep_gefswave025_ensemble_mean";
    Model[Model["geosphere_arome_austria"] = 138] = "geosphere_arome_austria";
    Model[Model["geosphere_seamless"] = 139] = "geosphere_seamless";
    Model[Model["chmi_aladin_cz_1km"] = 140] = "chmi_aladin_cz_1km";
    Model[Model["ecmwf_ifs_europe_ensemble"] = 141] = "ecmwf_ifs_europe_ensemble";
    Model[Model["ecmwf_ifs_europe_ensemble_mean"] = 142] = "ecmwf_ifs_europe_ensemble_mean";
    Model[Model["ecmwf_aifs_europe_ensemble"] = 143] = "ecmwf_aifs_europe_ensemble";
    Model[Model["ecmwf_aifs_europe_ensemble_mean"] = 144] = "ecmwf_aifs_europe_ensemble_mean";
    Model[Model["google_weathernext2_ensemble"] = 145] = "google_weathernext2_ensemble";
    Model[Model["google_weathernext2_ensemble_mean"] = 146] = "google_weathernext2_ensemble_mean";
