...
(function (Variable) {
    ...
    Variable[Variable["wind_u_component"] = 149] = "wind_u_component";
    Variable[Variable["wind_v_component"] = 150] = "wind_v_component";
    Variable[Variable["temperature_max24h"] = 151] = "temperature_max24h";
    Variable[Variable["temperature_min24h"] = 152] = "temperature_min24h";
    Variable[Variable["temperature_mean24h"] = 153] = "temperature_mean24h";
    Variable[Variable["snow_density"] = 154] = "snow_density";
    Variable[Variable["longwave_radiation"] = 155] = "longwave_radiation";
    Variable[Variable["sea_ice_cover"] = 156] = "sea_ice_cover";
    Variable[Variable["k_index"] = 157] = "k_index";
    Variable[Variable["roughness_length"] = 158] = "roughness_length";
    Variable[Variable["potential_evapotranspiration"] = 159] = "potential_evapotranspiration";
    Variable[Variable["wave_peak_period"] = 160] = "wave_peak_period";
    Variable[Variable["temperature_max6h"] = 161] = "temperature_max6h";
    Variable[Variable["temperature_min6h"] = 162] = "temperature_min6h";
    Variable[Variable["lightning_density"] = 163] = "lightning_density";
    Variable[Variable["sea_ice_thickness"] = 164] = "sea_ice_thickness";
    Variable[Variable["shortwave_radiation_clear_sky_instant"] = 165] = "shortwave_radiation_clear_sky_instant";
    Variable[Variable["sea_water_salinity"] = 166] = "sea_water_salinity";
    Variable[Variable["total_column_water"] = 167] = "total_column_water";
    Variable[Variable["air_density"] = 168] = "air_density";
